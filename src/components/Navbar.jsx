        ...
        <div className='navbar content-style'>
            <div className="navbar-start">
                ...
                <div className='dropdown'>
                    ...
                    <ul className='menu w-[60vw] rounded-md mt-2 space-y-4 list-none -ml-2 text-xl lg:hidden dropdown-content bg-base-100 z-[1] shadow-lg h-screen p-2' tabIndex={0}>
                        <Navlinks/>
                    </ul>
                </div>
